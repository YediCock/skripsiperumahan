        ...
        <div class="row mb-4 layout-spacing layout-top-spacing">
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="widget-content widget-content-area blog-create-section">
                    ...
                    <div wire:key="wrapper-siteplan-section">
                        @if($selectedCategoryData && $selectedCategoryData->site_plan_image)
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                <label class="form-label fw-bold">
                                    Penempatan Unit pada Site Plan
                                    <span class="text-info d-block" style="font-size: 12px; font-weight: normal;">
                                        *Klik pada area kapling gambar denah di bawah untuk menentukan titik lokasi unit rumah secara otomatis.
                                    </span>
                                </label>
