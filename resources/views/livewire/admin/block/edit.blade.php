                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Blok</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row layout-spacing layout-top-spacing">
            <div class="col-xxl-8 col-xl-8 col-lg-8">
                <div class="widget-content widget-content-area blog-create-section">
                    <form wire:submit="save({{ $block->id }})">
                        <div class="row mb-4">
                            <div class="col-sm-6">
                                ...
                                <select wire:model="home_category_id" class="form-select">
                                    ...
                                    @foreach ($categories as $cat)
                                        <option value="{{ $cat->id }}" {{ $cat->id == $block->home_category_id ? 'selected' : '' }}>{{ $cat->name }}</option>
                                    @endforeach
                                </select>
